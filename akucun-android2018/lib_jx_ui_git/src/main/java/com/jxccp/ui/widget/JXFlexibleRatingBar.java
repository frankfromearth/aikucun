...
public class JXFlexibleRatingBar extends RatingBar {
    ...
    public JXFlexibleRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        getXmlAttrs(context, attrs);
        init();
    }

    public JXFlexibleRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void getXmlAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.JxFlexibleRatingBar, 0, 0);
        try {
            colorOutlineOn = a.getInteger(R.styleable.JxFlexibleRatingBar_jxcolorOutlineOn, Color.rgb(0x11, 0x11, 0x11));
            colorOutlineOff = a.getInteger(R.styleable.JxFlexibleRatingBar_jxcolorOutlineOff, Color.rgb(0x61, 0x61, 0x61));
            colorOutlinePressed = a.getInteger(R.styleable.JxFlexibleRatingBar_jxcolorOutlinePressed, Color.rgb(0xFF, 0xB7, 0x4D));
            colorFillOn = a.getInteger(R.styleable.JxFlexibleRatingBar_jxcolorFillOn, Color.rgb(0xFF, 0x98, 0x00));
            colorFillOff = a.getInteger(R.styleable.JxFlexibleRatingBar_jxcolorFillOff, Color.TRANSPARENT);
            colorFillPressedOn = a.getInteger(R.styleable.JxFlexibleRatingBar_jxcolorFillPressedOn, Color.rgb(0xFF, 0xB7, 0x4D));
            colorFillPressedOff = a.getInteger(R.styleable.JxFlexibleRatingBar_jxcolorFillPressedOff, Color.TRANSPARENT);
            polygonVertices = a.getInteger(R.styleable.JxFlexibleRatingBar_jxpolygonVertices, 5);
            polygonRotation = a.getInteger(R.styleable.JxFlexibleRatingBar_jxpolygonRotation, 0);
            strokeWidth = (int) a.getDimension(R.styleable.JxFlexibleRatingBar_jxstrokeWidth, -1);
        } finally {
            a.recycle();
        }
    }
