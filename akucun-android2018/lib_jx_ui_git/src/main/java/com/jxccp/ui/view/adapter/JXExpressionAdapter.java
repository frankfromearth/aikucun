 ...
 * GridView表情的adpater
 */
public class JXExpressionAdapter extends ArrayAdapter<String> {

    public JXExpressionAdapter(Context context, int textViewResourceId,
            List<String> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(getContext(), R.layout.jx_row_expression,
                    null);
        }
