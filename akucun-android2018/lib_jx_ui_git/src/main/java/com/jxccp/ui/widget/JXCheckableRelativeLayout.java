...
/**
 * This is a simple wrapper for {@link android.widget.RelativeLayout} that implements the {@link android.widget.Checkable}
 ...
 */
public class JXCheckableRelativeLayout extends RelativeLayout implements Checkable {
    private static final int[] CHECKED_STATE_SET = {android.R.attr.state_checked};

    private boolean mChecked = false;

    public JXCheckableRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
