...
public final class ViewfinderView extends View
{
    ...
    {
        tipText = context.getResources().getString(R.string.scan_tip);
        ...
        float fontSize = context.getResources().getDimension(R.dimen.text_size_text);
        this.paintText.setTextSize(fontSize);
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        } else
        {
            ...
            this.paintText.getTextBounds(tipText, 0, tipText.length(), rectText);
            canvas.drawText(tipText, (frame.left + frame.right - rectText.width()) / 2, 80 + frame.bottom, this.paintText);
