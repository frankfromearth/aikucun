...
public class ChasingDots extends SpriteContainer
{
    ...
    protected void onBoundsChange(Rect bounds)
    {
        ...
        getChildAt(0).setDrawBounds(bounds.right - drawW, bounds.top, bounds.right, bounds.top +
                drawW);
        getChildAt(1).setDrawBounds(bounds.right - drawW, bounds.bottom - drawW, bounds.right,
                bounds.bottom);
    }
