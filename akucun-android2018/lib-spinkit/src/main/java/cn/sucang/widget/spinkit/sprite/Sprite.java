package cn.sucang.widget.spinkit.sprite;
...
import cn.sucang.widget.spinkit.animation.AnimationUtils;
import cn.sucang.widget.spinkit.animation.FloatProperty;
import cn.sucang.widget.spinkit.animation.IntProperty;
...
public abstract class Sprite extends Drawable implements ValueAnimator.AnimatorUpdateListener,
        Animatable, Drawable.Callback
{
    ...
    @SuppressWarnings("unused")
    public static final Property<Sprite, Integer> TRANSLATE_X = new IntProperty<Sprite>
            ("translateX")
    {
        @Override
        public void setValue(Sprite object, int value)
    ...
    @SuppressWarnings("unused")
    public static final Property<Sprite, Integer> TRANSLATE_Y = new IntProperty<Sprite>
            ("translateY")
    {
        @Override
        public void setValue(Sprite object, int value)
    ...
    public static final Property<Sprite, Float> TRANSLATE_X_PERCENTAGE = new
            FloatProperty<Sprite>("translateXPercentage")
    {
        @Override
    ...
    public static final Property<Sprite, Float> TRANSLATE_Y_PERCENTAGE = new
            FloatProperty<Sprite>("translateYPercentage")
    {
        @Override
        public void setValue(Sprite object, float value)
        {
