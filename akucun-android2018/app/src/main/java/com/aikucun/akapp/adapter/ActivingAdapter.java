...
import com.aikucun.akapp.adapter.viewholder.ActivingViewHolder;
...
public class ActivingAdapter extends RecyclerArrayAdapter<Product> {
    ...
    public ActivingAdapter(Context context) {
        super(context);
    }
...
//        skuAdapter = new SkuAdapter(new ArrayList<ProductSKU>(), getContext());
        ActivingViewHolder viewHolder = new ActivingViewHolder(parent);
    ...
    public void onViewAttachedToWindow(BaseViewHolder holder) {
        ...
        if (holder instanceof ActivingViewHolder) {
            ActivingViewHolder mActivingViewHolder = (ActivingViewHolder) holder;
            mActivingViewHolder.refreshTime();
        }
    ...
    private void goToPinPai(Product product) {
        ...
        ActivityUtils.startActivity((Activity) getContext(), PinpaiActivity.class, bundle);
    }
    ...
    public void OnBindViewHolder(BaseViewHolder holder, final int position) {
        ...
        final ActivingViewHolder viewHolder = (ActivingViewHolder) holder;
