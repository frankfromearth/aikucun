...
public class GlideCacheUtil {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(AppContext.getInstance().getCacheDir() + "/" + GlideCacheConfig.GLIDE_CARCH_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(AppContext.getInstance().getCacheDir() + "/" + GlideCacheConfig.GLIDE_CARCH_DIR, true);
    }
