...
import com.aikucun.akapp.adapter.CutGoodsAdapter;
...
public class BaseCutGoodsFragment extends BaseFragment implements
        RecyclerArrayAdapter.OnLoadMoreListener, CutGoodsAdapter.OnItemEventListener {

    public CutGoodsAdapter cutGoodsAdapter;
    ...
    public void initView(View view) {
        ...
        cutGoodsAdapter = new CutGoodsAdapter(getActivity());
        cutGoodsAdapter.setOnItemEventListener(this);
//        productAdapter.setMore(R.layout.view_load_more, this);
        cutGoodsAdapter.setNoMore(R.layout.view_nomore);
        ...
        recyclerView.setAdapter(cutGoodsAdapter);
    }
            ...
            public void onSendComment(final Object object, final String content) {
                ...
                CommentsApiManager.sendComment((Activity) getActivity(), mProduct.getId(), content, new JsonDataCallback() {
                    ...
                    public void onApiSuccess(JSONObject jsonObject, Call call, ApiResponse jsonResponse) {
                        ...
                        cutGoodsAdapter.notifyDataSetChanged();
                    }
            ...
            public void onApiSuccess(JSONObject jsonObject, Call call, ApiResponse jsonResponse) {
                ...
                if (1 == follow) {
                    ...
                    if (isNeedToRemoveUnfollowdProduct()) {
                        cutGoodsAdapter.remove(product);
                    }
                }
                cutGoodsAdapter.notifyDataSetChanged();
            }
