...
public class TDevice
{
    ...
    private static Boolean _isCameraAvailable = null;
    ...
    public static boolean isCameraAvailable()
    {
        if (_isCameraAvailable == null)
        {
            ...
            _isCameraAvailable = Boolean.valueOf(canUse);
        }
        return _isCameraAvailable.booleanValue();
    }
    ...
    public static String getIMEI()
    {
        ...
        //生成最终的唯一标识
        try {
            imei = RSAUtils.md5String(imeiBuilder.toString());
        } catch (Exception e) {
            imei = "";
        }
    ...
    public static void openApp(Context context, String packageName)
    {
        ...
        {
            SCLog.log("Action:" + mainIntent.getAction());
        }
