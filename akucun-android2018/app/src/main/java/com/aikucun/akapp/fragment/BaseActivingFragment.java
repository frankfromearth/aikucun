...
import com.aikucun.akapp.adapter.ActivingAdapter;
...
public class BaseActivingFragment extends BaseFragment implements
        RecyclerArrayAdapter.OnLoadMoreListener, ActivingAdapter.OnItemEventListener {

    public ActivingAdapter activingAdapter;
    ...
    public void initView(View view) {
        ...
        activingAdapter = new ActivingAdapter(getActivity());
        activingAdapter.setOnItemEventListener(this);
//        productAdapter.setMore(R.layout.view_load_more, this);
        activingAdapter.setNoMore(R.layout.view_nomore);
        ...
        recyclerView.setAdapter(activingAdapter);
    }
    ...
    protected void requestBuyProduct(final Product product, final ProductSKU sku) {
        ...
        if (!AppContext.get(AppConfig.UDK_REMARK_DATA, true)) {
            // FIXME: 2018/1/5 
            // new AppGoodsManager(activingAdapter, product, sku, "", (BaseActivity) getActivity()).requestBuyProduct(sku, null);
            return;
        }
        ...
        builder.setPositiveButton("下单", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // FIXME: 2018/1/5 
               // new AppGoodsManager(productAdapter, product, sku, remark, (BaseActivity) getActivity()).requestBuyProduct(sku, null);
            }
        });
        builder.show();
            ...
            public void onSendComment(final Object object, final String content) {
                ...
                CommentsApiManager.sendComment((Activity) getActivity(), mProduct.getId(), content, new JsonDataCallback() {
                    ...
                    public void onApiSuccess(JSONObject jsonObject, Call call, ApiResponse jsonResponse) {
                        ...
                        activingAdapter.notifyDataSetChanged();
                    }
            ...
            public void onApiSuccess(JSONObject jsonObject, Call call, ApiResponse jsonResponse) {
                ...
                if (1 == follow) {
                    ...
                    if (isNeedToRemoveUnfollowdProduct()) {
                        activingAdapter.remove(product);
                    }
                }
                activingAdapter.notifyDataSetChanged();
            }
