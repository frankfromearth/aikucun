...
public class BaseProductFragment extends BaseFragment implements
        RecyclerArrayAdapter.OnLoadMoreListener, ProductAdapter.OnItemEventListener {
    ...
    protected void requestBuyProduct(final Product product, final ProductSKU sku) {
        ...
        if (!AppContext.get(AppConfig.UDK_REMARK_DATA, true)) {
            new AppGoodsManager(productAdapter, product, sku, "", (BaseActivity) getActivity()).requestBuyProduct(sku, null);
            return;
        }
