...
public class AddressPopWindow extends PopupWindow implements View.OnClickListener
{
    ...
    public AddressPopWindow(final Context context, String province, String city, String area)
    {
        super(context);
        this.context = context;
        View view = View.inflate(context, R.layout.layout_edit_address_pop, null);
        ...
        initProvinces();
        provinceAdapter = new AddressTextAdapter(context, arrProvinces, getProvinceItem
                (strProvince), maxsize, minsize);
        wvProvince.setVisibleItems(5);
        wvProvince.setViewAdapter(provinceAdapter);
        wvProvince.setCurrentItem(getProvinceItem(strProvince));

        initCitys(mCitisDatasMap.get(strProvince));
        cityAdapter = new AddressTextAdapter(context, arrCitys, getCityItem(strCity), maxsize,
                minsize);
        ...
        areaAdapter = new AddressTextAdapter(context, arrAreas, getAreaItem(strArea), maxsize,
                minsize);
...
//            InputStream is = context.getClass().getClassLoader().getResourceAsStream("assets/" +
//                    "city.json");
//            int len = -1;
...
//        }
    ...
    public void initAreas(String[] areas)
    {
        ...
        {
            String[] area = mAreaDatasMap.get("浦东新区");
            arrAreas.clear();
