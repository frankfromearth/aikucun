...
import com.aliyun.video.util.Utils;
import com.aliyun.video.util.VodResult;
...
public class SnapCropSetting extends Activity implements View.OnClickListener,CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snap_crop_setting);
        initView();
        initAssetPath();
        copyAssets();
    }
